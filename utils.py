...
def compression_ratio(compressor, decompressor, n_frames):
    original_unit_size = decompressor.output_size
    compressed_unit_size = decompressor.input_size
    return (compressed_unit_size * n_frames + count_parameters(compressor) + count_parameters(decompressor)) / (original_unit_size * n_frames)